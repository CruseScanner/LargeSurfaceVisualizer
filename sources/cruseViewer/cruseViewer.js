...
var CruseViewer = function (parentElement, showAdvancedControls) {
    ...
    this.lightSettingsOverlay = this.createOverlayWindow(
        'Lighting',
...
CruseViewer.prototype = {
        ...
        var overlayWindow = {
            ...
            _updateVisibility: function () {
                captionElement.style.visibility =
                    this._visible &&
                    captionElement.classList.contains('cruse-scanviewer-overlay-active')
                        ? 'visible'
                        : 'hidden';
            }
        };
    ...
    open: function (image) {
        ...
        this.showLightsButton.element.style.visibility = this.is3DImage(image)
            ? 'visible'
            : 'hidden';
    ...
    update3DViewer: function (image) {
        ...
        if (this.scanViewerWidget == undefined) {
            this.scanViewerWidget = new ScanViewerWidget(
                this.viewer3dElement,
                this.lightSettingsOverlay.contentElement
            );
        } else {
            this.scanViewerWidget.stop();
        }
    ...
    createButtons: function (toolbarElement) {
        ...
        this.showLightsButton = this.createButton(
            toolbarElement,
            'lights',
            'Show/Hide Lighting Settings',
            function () {
