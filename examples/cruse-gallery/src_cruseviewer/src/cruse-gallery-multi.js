...
var Gallery = new Class({
  ...
  create: function( container ){
    ...
    this.viewer1 = new Element( 'div',{
      'class': 'viewer1'
    }).inject(this.container);

   // Create the iipmooviewer container
    this.viewer2 = new Element( 'div',{
      'class': 'viewer2'
    }).inject(this.container);
  ...
  createThumbnails: function(){
    ...
    Array.each(this.images, function(i,index){
      ...
      var src = (i.server||'/fcgi-bin/iipsrv.fcgi') + '?FIF=' + i.image1 +
  ...
  createViewer: function(image){
    this.iipmooviewer = new IIPMooViewer( this.viewer1, {
      server: this.images[0].server || null,
      prefix: '../cruseviewer/images/',
      render: 'spiral',
      image: this.images[0].image1,
      credit: '<a href="' + this.images[0].caption1 + '" type="application/octet-stream" style="color:#fff"><img src="../cruseviewer/images/download.png" /></a>',
      scale: this.images[0].scale || null,
      showNavWindow: false,
      showNavButtons: false
    }),
   this.iipmooviewer2 = new IIPMooViewer( this.viewer2, {
      server: this.images[0].server || null,
      prefix: '../cruseviewer/images/',
      render: 'spiral',
      image: this.images[0].image2,
      credit: '<a href="' + this.images[0].caption2 + '" type="application/octet-stream" style="color:#fff"><img src="../cruseviewer/images/download.png" /></a>',
      scale: this.images[0].scale || null,
      navigation: {buttons: ['zoomIn','zoomOut','reset','print','rotateLeft','rotateRight']}
   });
  IIPMooViewer.synchronize([this.iipmooviewer,this.iipmooviewer2]);
  },
  ...
  updateViewer: function( image ){
    ...
    this.iipmooviewer.setCredit( '<a href="' + image.caption1 + '" type="application/octet-stream" style="color:#fff"><img src="../cruseviewer/images/download.png" /></a>');
    this.iipmooviewer.viewport = image.view || null;
    this.iipmooviewer.changeImage( image.image1 );
    this.iipmooviewer2.setCredit( '<a href="' + image.caption2 + '" type="application/octet-stream" style="color:#fff"><img src="../cruseviewer/images/download.png" /></a>');
    this.iipmooviewer2.viewport = image.view2 || null;
    this.iipmooviewer2.changeImage( image.image2 );
