...
IIPMooViewer.implement({
  ...
  createBlendingInterface: function() {
    ...
    new Element( 'div', {
      'class': 'blending',
      'html': '<h2 title="<h2>ImageStacking Simulation</h2>Select the pair of images you wish<br/>to compare from the menus below.<br/>Use the slider to blend smoothly<br/>between them">ImageStacking Simulation</h2><span>1. Scan Mode</span><select id="baselayer"></select><br/><br/><span>Move slider to simulate ImageStacking:</span><br/><div id="area"><div id="knob"></div></div><br/><span>2. Scan Mode</span><select id="overlay"></select><br/>'
